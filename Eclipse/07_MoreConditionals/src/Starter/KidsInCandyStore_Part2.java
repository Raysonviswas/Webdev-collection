...
public class KidsInCandyStore_Part2 {
	...
	public static void main(String[] args) {
		...
		if (price > 0) {
			...
			if (money > 0) {
				...
				System.out
						.printf("If price is %sp and you have %sp you will be able to buy %s bags",
								price, money, numBags);
			}
			...
			{
				System.out
						.println("Money must be a non-negative numeric value");
			}
		}
